...
const LoadingState = ({ currentStep, agentThoughts = [] }: LoadingStateProps) => {
  ...
  const progressItems: ProgressItem[] = [
    { 
      ...
      description: "Analyzing the job posting for key skills and requirements"
    },
    { 
      id: AgentStep.PROFILE_ANALYSIS, 
      icon: "user", 
      text: "Analyzing your profile",
      description: "Reviewing resume and LinkedIn profile" 
    },
    {
      id: AgentStep.HIGHLIGHT_GENERATION,
      icon: "star",
      text: "Identifying key strengths",
      description: "Highlighting relevant qualifications for the role"
    },
    {
      id: AgentStep.COMPANY_RESEARCH,
      icon: "building",
      text: "Researching company",
      description: "Learning about the company culture and values"
    },
    {
      id: AgentStep.INTERVIEW_PATTERN_RESEARCH,
      icon: "list-checks",
      text: "Interview pattern analysis",
    ...
    { 
      ...
      description: "Ensuring comprehensive and accurate preparation"
    },
  ];
